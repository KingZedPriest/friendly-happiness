...
export function Form() {
    ...
    return (
        <div className='flex flex-col gap-y-5'>
            ...
            <Input type="text" placeholder='e.g johndoes@gmail.com' label='Email Address' id='email' value={data.emailAddress} onChange={(e) => updateField("emailAddress", e.target.value)} required />
